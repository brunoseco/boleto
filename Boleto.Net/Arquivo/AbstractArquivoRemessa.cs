...
namespace BoletoNet
{
    public abstract class AbstractArquivoRemessa: IArquivoRemessa
    {
        ...
        /// </summary>
        public virtual byte[] GerarArquivoRemessa(string numeroConvenio, IBanco banco, Cedente cedente, Boletos boletos, String arquivo, int numeroArquivoRemessa)
        {
            _banco = banco;
            _cedente = cedente;
            _boletos = boletos;
            ...
            return _arquivoRemessa.GerarArquivoRemessa(numeroConvenio, banco, cedente, boletos, arquivo, numeroArquivoRemessa);
        }
