...
namespace BoletoNet
{
    public class C2of5i : BarCodeBase
    {
        ...
        public String ToString(String path)
        {
            ...
            sb.Append("<img src=\"" + path + "p.gif\" width=" + fino + " height=" + altura + " border=0 />");
            sb.Append("<img src=\"" + path + "b.gif\" width=" + fino + " height=" + altura + " border=0 />");
            sb.Append("<img src=\"" + path + "p.gif\" width=" + fino + " height=" + altura + " border=0 />");
            sb.Append("<img src=\"" + path + "b.gif\" width=" + fino + " height=" + altura + " border=0 />");
            ...
            while (this.Code.Length > 0)
            {
                ...
                for (int j = 0; j < f.Length; j++)
                {
                    ...
                    if (j % 2 == 0)
                        sb.Append("<img src=\"" + path + "p.gif\" width=" + tempWidth + " height=" + altura + " border=0 />");
                    else
                        sb.Append("<img src=\"" + path + "b.gif\" width=" + tempWidth + " height=" + altura + " border=0 />");
                }
            }

	        // Draw guarda final
            sb.Append("<img src=\"" + path + "p.gif\" width=" + largo + " height=" + altura + " border=0 />");
            sb.Append("<img src=\"" + path + "b.gif\" width=" + fino + " height=" + altura + " border=0 />");
            sb.Append("<img src=\"" + path + "p.gif\" width=1 height=" + altura + " border=0 />");
