...
namespace BoletoNet
{
    ...
    internal class Banco_Sicredi : AbstractBanco, IBanco
    {
        ...
        public override void FormataCodigoBarra(Boleto boleto)
        {
            ...
            string cmp_livre =  boleto.Carteira + "1" + boleto.NossoNumero + boleto.Cedente.ContaBancaria.Agencia + boleto.Cedente.ContaBancaria.OperacaoConta + boleto.Cedente.Codigo + "10";
        ...
        */
        ...
        public string DigNossoNumeroSicredi(Boleto boleto)
        {
            ...
            string posto = boleto.Cedente.ContaBancaria.OperacaoConta; //código do posto beneficiário (pp)
