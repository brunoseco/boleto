...
namespace BoletoNet
{
    public interface IBanco
    {
        ...
        /// Gera os registros de detalhe do arquivo de remessa
        /// </summary>
        string GerarDetalheRemessaTipo2(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo);
        /// <summary>
        /// Gera os registros de detalhe do arquivo de remessa
        /// </summary>
        string GerarDetalheRemessaTipo5(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo);
        /// <summary>
        ...
        /// Gera o Trailer do arquivo de remessa
        /// </summary>
        string GerarTrailerRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo, Cedente cedente, decimal vltitulostotal);
        /// <summary>
        ...
        DetalheRetorno LerDetalheRetorno7CNAB400(string registro);
